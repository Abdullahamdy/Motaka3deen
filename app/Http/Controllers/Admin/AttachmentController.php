...
class AttachmentController extends Controller
{
    ...
    protected $model ;
    protected $image;
    protected $viewsDomain = 'admin/attachments.';
    protected $url = 'admin/attachments';
    public function __construct()
    {
        $this->model = new Gallary();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasfile('image')) {
            ...
            foreach($files as $file){
                ...
                $new = $file->storeAs('Accessories/Attachments', $name, 'upload_attachments');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasfile('image')) {
            ...
            foreach($files as $file){
                ...
                $file->storeAs('Accessories/Attachments', $name, 'upload_attachments');
    ...
    public function destroy($id)
    {
        ...
        foreach($images as $image){
            ...
            File::delete(public_path('Accessories/Attachments/'.$image->filename));
        }
    ...
    public function getAttachment($id){
        ...
        $details = Gallary::where('id',$id)->get();
    ...
    public function deleteAttachment($filename){
        $image = Image::where('filename',$filename)->where('imagable_type','App\Models\Gallary')->first();
// dd($image);
        $data = [
            'status' => 1,
            'message' => 'تم الحذف بنجاح',
        ...
        File::delete(public_path('Accessories/Attachments/'.$filename));
        $image->delete();
        return Response::json($data, 200);
    ...
    public function getVideo(){
        $model = $this->model;
       return $this->view('show_video',compact('model'));
