...
class ServeceController extends Controller
{
    ...
    protected $model ;
    protected $viewsDomain = 'admin/serveces.';
    protected $url = 'admin/serveces';
    public function __construct()
    {
        $this->model = new Servece();
    ...
    public function store(Request $request)
    {
        ...
        $error_sms =
            [
                ...
                'name.required' => 'الرجاء ادخال عنوان الخدمة ',
                'text.required' => 'الرجاء ادخال نص الخدمة ',
