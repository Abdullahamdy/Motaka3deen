...
class QuestionController extends Controller
{
    ...
    protected $model ;
    protected $viewsDomain = 'admin/question.';
    protected $url = 'admin/question';
    public function __construct()
    {
        $this->model = new Qusetion();
    ...
    public function store(Request $request)
    {
        ...
        $error_sms =
            [
                ...
                'question.required' => 'الرجاء ادخال عنوان السؤال ',
                'answer.required' => 'الرجاء ادخال نص السؤال ',
