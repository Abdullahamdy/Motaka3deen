    ...
    <div class="ibox box-primary">
        <div class="ibox-title">
            <div class="pull-right">
                ...
                <a href="{{url('admin/serveces/create')}}" class="btn btn-primary">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($records as $record)
                                ...
                                <td>{{optional($record)->text}}</td>
                                 ...
                                 <td class="text-center"><a href="{{url('admin/serveces/' . $record->id .'/edit')}}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a></td>
                                 <td class="text-center">
                                    <button
                                    id="{{$record->id}}"
                                    data-token="{{ csrf_token() }}"
                                    data-route="{{url('admin/serveces/'.$record->id)}}"
                                    type="button"
